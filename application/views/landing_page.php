            ...
            <div class="container">
               ...
               <div class="collapse_menu deactive">
                  ...
                  <ul class="nav">
                     ...
                     <li class="nav-item">
                        <a class="nav-link" href="<?php echo base_url('login');?>" style="background:none;border:1px solid #fff;with:20px;border-radius:15px">Login</a>
                     </li>
                     <li class="nav-item">
                        <a class="nav-link" href="<?php echo base_url('register');?>" style="background:#00BFD8;text-color:#fff;with:20px;border-radius:15px;margin-left:10px">Daftar</a>
                     </li>
                  </ul>
               </div>
            </div>
               ...
               <div class="row Section">
                  <div class="col">
                     <div class="box">
                        ...
                        <p>Selamat datang di Web Sistem Informasi Penggajian Karyawan <br>Kokojotasik</p>
                     </div>
                  </div>
         ...
         <div class="Section">
            <div class="text-center">
               ...
               <div class="subHeading">
                  Berikut informasi lebih lengkap tentang website <br>informasi penggajian karyawan Kokojotasik</div>
            </div>
         ...
         <div class="container">
            <div class="row">
               <div class="col-12 text-center my-3">
                  Copyright &copy; Kelompok 6 | Penggajian 2024
               </div>
            </div>
         </div>
      </div>
